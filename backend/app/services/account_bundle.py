...
def get_account_dashboard_bundle(session: Session, account_id: str, *, workspace_id: str | None = None) -> Account | None:
...
def get_latest_job_for_account(session: Session, account_id: str, *, workspace_id: str | None = None) -> Job | None:
