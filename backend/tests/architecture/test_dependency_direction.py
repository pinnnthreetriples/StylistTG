...
def test_feature_module_dependency_graph_has_no_cycles() -> None:
    # PR4 (#233): the historical account_core ↔ account_safety pair and
    # the account_core ↔ warmup ↔ account_safety triangle were broken by
    # extracting the shared lookup/capabilities/runtime primitives into a
    # neutral `account_shared` module. No documented cycle exceptions
    # remain — the feature-module graph is fully acyclic.
