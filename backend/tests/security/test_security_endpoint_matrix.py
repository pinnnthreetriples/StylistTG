...
ENDPOINT_MATRIX: list[tuple[str, str, str, bool]] = [
    ...
    ("GET", "/api/neuro-commenting/campaigns/{campaign_id}/stats", "viewer", False),
    ("GET", "/api/neuro-commenting/campaigns/{campaign_id}/account-stats", "viewer", False),
    ...
    ("DELETE", "/api/neuro-commenting/limits/{limit_id}", "operator", True),
    ("GET", "/api/neuro-commenting/channel-rules", "viewer", False),
    ("POST", "/api/neuro-commenting/channel-rules", "operator", True),
    ("DELETE", "/api/neuro-commenting/channel-rules/{rule_id}", "operator", True),
    ("POST", "/api/neuro-commenting/targets/{target_id}/blacklist", "operator", True),
    ("POST", "/api/neuro-commenting/targets/{target_id}/whitelist", "operator", True),
    ("POST", "/api/neuro-commenting/targets/{target_id}/pause", "operator", True),
    ("POST", "/api/neuro-commenting/targets/{target_id}/resume", "operator", True),
    ...
    ("GET", "/api/neuro-commenting/prompt-presets", "viewer", False),
    (
        "DELETE",
