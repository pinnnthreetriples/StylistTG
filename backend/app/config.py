...
class Settings(BaseSettings):
    ...
    redis_socket_connect_timeout_sec: float = 3.0
    redis_health_check_interval_sec: int = 30
    redis_retry_retries: int = 3
    ...
    # Emergency kill-switch: when True, get_workspace_safety_policy() returns a
    # transient neutral policy and the Settings UI disables admin controls.
    workspace_safety_policy_temporarily_disabled: bool = False
