...
class TestCrossWorkspaceReadBlocked:
    ...
    # test-analyzer: disable=STG003 reason="STG003 false positive — body assertion verifies no foreign-id leaks (the workspace-isolation contract); error envelope intentionally generic for foreign-workspace probes"
