...
DECLARED_LAYER_FILES: dict[str, tuple[Path, ...]] = {
    ...
    "router": (
        ...
        Path("neuro_commenting/router_attempts_events.py"),
        Path("neuro_commenting/router_base.py"),
        Path("neuro_commenting/router_campaign_accounts.py"),
        Path("neuro_commenting/router_campaigns.py"),
        Path("neuro_commenting/router_comments.py"),
        Path("neuro_commenting/router_common.py"),
        Path("neuro_commenting/router_lifecycle.py"),
        Path("neuro_commenting/router_limits_rules.py"),
        Path("neuro_commenting/router_observe.py"),
        Path("neuro_commenting/router_targets.py"),
