...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("consent_actor_user_id", sa.String(36), nullable=True),
        ...
        sa.UniqueConstraint("workspace_id", "idempotency_key", name="uq_account_onboarding_batch_workspace_idempotency"),
    )
    op.create_index("ix_account_onboarding_batch_workspace_status", "account_onboarding_batch", ["workspace_id", "status"])
    op.create_index("ix_account_onboarding_batch_workspace_created", "account_onboarding_batch", ["workspace_id", "created_at"])
    ...
    op.create_index("ix_account_onboarding_artifact_workspace_status", "account_onboarding_artifact", ["workspace_id", "status"])
    op.create_index("ix_account_onboarding_artifact_expires", "account_onboarding_artifact", ["expires_at"])
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("batch_id", "position", name="uq_account_onboarding_item_batch_position"),
    )
    op.create_index("ix_account_onboarding_item_workspace_batch", "account_onboarding_item", ["workspace_id", "batch_id"])
    op.create_index("ix_account_onboarding_item_batch_status", "account_onboarding_item", ["batch_id", "status"])
    op.create_index("ix_account_onboarding_item_workspace_phone_hash", "account_onboarding_item", ["workspace_id", "phone_normalized_hash"])
    op.create_foreign_key("fk_account_onboarding_artifact_item_id", "account_onboarding_artifact", "account_onboarding_item", ["item_id"], ["id"])
    ...
    op.create_index("ix_account_onboarding_event_batch_created", "account_onboarding_event", ["batch_id", "created_at"])
    op.create_index("ix_account_onboarding_event_item_created", "account_onboarding_event", ["item_id", "created_at"])


def downgrade() -> None:
    op.drop_index("ix_account_onboarding_event_item_created", table_name="account_onboarding_event")
    op.drop_index("ix_account_onboarding_event_batch_created", table_name="account_onboarding_event")
    op.drop_table("account_onboarding_event")
    op.drop_constraint("fk_account_onboarding_artifact_item_id", "account_onboarding_artifact", type_="foreignkey")
    op.drop_index("ix_account_onboarding_item_workspace_phone_hash", table_name="account_onboarding_item")
    op.drop_index("ix_account_onboarding_item_batch_status", table_name="account_onboarding_item")
    op.drop_index("ix_account_onboarding_item_workspace_batch", table_name="account_onboarding_item")
    op.drop_table("account_onboarding_item")
    op.drop_index("ix_account_onboarding_artifact_expires", table_name="account_onboarding_artifact")
    op.drop_index("ix_account_onboarding_artifact_workspace_status", table_name="account_onboarding_artifact")
    op.drop_table("account_onboarding_artifact")
    op.drop_index("ix_account_onboarding_batch_workspace_created", table_name="account_onboarding_batch")
    op.drop_index("ix_account_onboarding_batch_workspace_status", table_name="account_onboarding_batch")
